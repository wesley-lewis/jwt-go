...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		signedToken, refreshSignedToken, err := helper.GenerateAllTokens(*foundUser.Email, *foundUser.FirstName, *foundUser.LastName, *foundUser.User_type, *foundUser.User_ID)
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
			return
		}
		helper.UpdateAllTokens(signedToken, refreshSignedToken, *foundUser.User_ID)
